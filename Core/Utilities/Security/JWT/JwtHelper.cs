...
namespace Core.Utilities.Security.JWT
{
    public class JwtHelper : ITokenHelper
    {
        ...
        {
            var jwt = new JwtSecurityToken(issuer: tokenOptions.Issuer, audience: tokenOptions.Audince, expires: _accessTokenExpiration, notBefore: DateTime.Now, claims: SetClaims(user, operationClaims, companyid), signingCredentials: signingCredentials);
            return jwt;
        }
